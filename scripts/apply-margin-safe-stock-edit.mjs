...
stock = replaceRequired(
  stock,
  'setEditPrixAchat(String(detail.prixAchat ?? 0));',
  'setEditPrixAchat(canSeeMargin ? String(detail.prixAchat ?? 0) : "");',
  "edit product opener",
);
stock = replaceRequired(
  stock,
...
api = replaceRequired(
  ...
  "updateProduct optional purchase price",
);
...
app = replaceRequired(
  app,
  '<RelationalStockView boutique={boutique} onUpdate={updateBoutique}',
  '<RelationalStockView boutique={boutique} canSeeMargin={canSeeMargin} onUpdate={updateBoutique}',
  "App StockView prop",
);
