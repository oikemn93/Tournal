...
assert(report.includes('title="Clients"') && report.includes('section === "clients"'), "Client section must exist and lazy-load");
assert(report.includes("customer_outstanding_global"), "Global customer outstanding KPI missing");
assert(report.includes("invoiced_revenue") && report.includes("sales_count"), "Client ranking metrics missing");
assert(report.includes("overdue_global"), "Overdue customer detail missing");
