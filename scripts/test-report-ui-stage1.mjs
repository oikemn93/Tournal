...
assert(activeView.includes('data-screen-source="canonical-report-v10-filters"') || activeView.includes('data-screen-source="canonical-report-v9-navigation"') || activeView.includes('data-screen-source="canonical-report-v8-ui"') || activeView.includes('data-screen-source="canonical-report-v7-ui"') || activeView.includes('data-screen-source="canonical-report-v6-ui"'), "UI refresh marker missing");
