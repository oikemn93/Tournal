create or replace function public.get_my_ops_profile()
returns jsonb
language sql
stable
security definer
...
revoke all on function public.get_my_ops_profile() from public;
...
revoke all on function public.get_ops_shell() from public;
