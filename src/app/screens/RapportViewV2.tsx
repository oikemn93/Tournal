...
export function ComptabiliteView({ boutique, canSeeMargin = false }: { boutique: Boutique; canSeeMargin?: boolean }) {
  ...
  return <div data-screen-source="canonical-report-v7-ui" className="space-y-4 pb-24">
    ...
    <div className="space-y-2">
      ...
      <Accordion title="Charges" subtitle="Où partent mes décaissements d’exploitation ?" icon={<Wallet size={17}/>} active={open==="charges"} onClick={()=>void toggle("charges")} color={RC}>{sectionLoading==="charges"?<Loading/>:<ChargesReportSection report={charges} metrics={metrics}/>}</Accordion>
