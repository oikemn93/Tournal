-- Audit-only reconciliation of the production final state.
-- This function already exists in production; the replay definition had drifted.
...
begin
  ...
  if p_supplier_id is not null then
    ...
    v_is_self_supplier := coalesce(v_supplier.linked_boutique_id = p_boutique_id, false);
  end if;
